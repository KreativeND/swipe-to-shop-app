...
interface ProductState {
  ...
  dislikedProducts: number[];
  cartProducts: number[];
  setProducts: (products: Product[]) => void;
  likeProduct: (id: number) => void;
  dislikeProduct: (id: number) => void;
  addToCart: (id: number) => void;
  nextProduct: () => void;
  resetState: () => void;
}

// Mock product data as provided
...
export const useProductStore = create<ProductState>()((set, get) => ({
  ...
  likeProduct: (id) => {
    ...
    set((state) => ({
      likedProducts: [...state.likedProducts, id]
    }));
  },
  ...
  dislikeProduct: (id) => {
    ...
    set((state) => ({
      dislikedProducts: [...state.dislikedProducts, id]
    }));
  },
